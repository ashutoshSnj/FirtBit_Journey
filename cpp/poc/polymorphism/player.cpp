...
struct Cricketplayer:public Player{
	...
	int runscore;
	 ...
	 Cricketplayer():Player(){
	  ...
	  void play(){
    cout<<this->name<<" is playing cricket,scoring runs and taking wickets."<<endl;
}
...
struct Football:public Player{
	...
	void play(){
    cout<<this->name<<" is playing football, aiming to score goals from the "<<this->position<<"position."<<endl;
} 
};
int main(){
Player *ptr;
