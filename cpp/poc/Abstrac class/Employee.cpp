...
int main(){
Employee*ep;
//Employee hh(58,"sfec",8947);
ep=new Salsemanager(12,"virat",52635,45236,58);
cout<<ep<<endl;
ep->display();
//ep points the salsmanager object we write the ep->display()
cout<<"salary is "<<ep->getsalary();
